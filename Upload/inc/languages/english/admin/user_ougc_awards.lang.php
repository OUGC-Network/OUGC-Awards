...
$l['setting_ougc_awards_modgroups_desc'] = 'Allowed usergroups to moderate this feature.';
$l['setting_ougc_awards_pagegroups'] = 'Awards Page Allowed Groups';
$l['setting_ougc_awards_pagegroups_desc'] = 'Allowed usergroups to view the awards page.';
$l['setting_ougc_awards_perpage'] = 'Items Per Page';
$l['setting_ougc_awards_perpage_desc'] = 'Maximun number of items to show per page in the ModCP queue list.';
...
$l['ougc_awards_form_pm_d'] = 'Write the content of the PM to send to users when awarded.<br />
	{1} = Username<br/>
	{2} = Award name<br/>
	{3} = Reason<br/>
	{4} = Image<br/>';
...
$l['ougc_awards_form_order_d'] = 'Order on which this custom reputation will be proccessed.';
...
$l['ougc_awards_error_give'] = 'The selected user either already has or doesn\'t have the selected award.';
